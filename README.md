...
[![](https://img.shields.io/badge/Singularity-GalaxyProject-blue)](https://depot.galaxyproject.org/singularity/biobb_pytorch:5.2.3--pyhad2cae4_0)
...
* Installation:
        ...
        pip install "biobb_pytorch>=5.2.3"
...
* Installation:
        ...
        conda install -c bioconda "biobb_pytorch>=5.2.3"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_pytorch:5.2.3--pyhad2cae4_0


* Usage:


        docker run quay.io/biocontainers/biobb_pytorch:5.2.3--pyhad2cae4_0 <command>
...
* Installation:
        ...
        singularity pull --name biobb_pytorch.sif https://depot.galaxyproject.org/singularity/biobb_pytorch:5.2.3--pyhad2cae4_0
