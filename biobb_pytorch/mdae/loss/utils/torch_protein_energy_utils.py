...
def get_convolutions(dataset, pdb_atom_names,
    ...
    bond_masks = np.zeros((bond_max_conv-1, N-(bond_max_conv-1) + 2*(bond_max_conv-2)),dtype=bool)
    ...
    angle_masks = np.zeros((len(angle_unique), N-(angle_max_conv-1)+2*(angle_max_conv-3)),dtype=bool)
    angle_weights=[]
    ...
    torsion_masks = np.zeros((len(torsion_unique), N-(torsion_max_conv-1)+2*(torsion_max_conv-4)),dtype=bool)
    torsion_weights = []
