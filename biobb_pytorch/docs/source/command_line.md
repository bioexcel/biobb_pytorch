...
build_model -h
```
    /Users/gbayarri/projects/BioBB/bin/build_model: line 1: import: command not found
    /Users/gbayarri/projects/BioBB/bin/build_model: line 2: import: command not found
    /Users/gbayarri/projects/BioBB/bin/build_model: line 3: import: command not found
    from: can't read /var/mail/typing
    from: can't read /var/mail/biobb_pytorch.mdae.models
    from: can't read /var/mail/biobb_pytorch.mdae.utils.model_utils
    from: can't read /var/mail/biobb_pytorch.mdae.utils.log_utils
    from: can't read /var/mail/biobb_common.tools.file_utils
    from: can't read /var/mail/biobb_common.tools
    from: can't read /var/mail/biobb_common.generic.biobb_object
    /Users/gbayarri/projects/BioBB/bin/build_model: line 13: syntax error near unexpected token `('
    /Users/gbayarri/projects/BioBB/bin/build_model: line 13: `class BuildModel(BiobbObject):'
### I / O Arguments
Syntax: input_argument (datatype) : Definition
...
### YAML
#### [Common config file](https://github.com/bioexcel/biobb_pytorch/blob/master/biobb_pytorch/test/data/config/config_LRP.yml)
```python
properties:
  Dataset:
    batch_size: 32
...
#### Command line
```python
LRP --config config_LRP.yml --input_model_pth_path output_model.pth --input_dataset_pt_path output_model.pt --output_results_npz_path output_results.npz
```
### JSON
#### [Common config file](https://github.com/bioexcel/biobb_pytorch/blob/master/biobb_pytorch/test/data/config/config_LRP.json)
```python
{
  "properties": {
    "Dataset": {
...
#### Command line
```python
LRP --config config_LRP.json --input_model_pth_path output_model.pth --input_dataset_pt_path output_model.pt --output_results_npz_path output_results.npz
```
